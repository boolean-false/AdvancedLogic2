...
**Версия 2.0.0 · Дополнение для WireMod 3.0.0 · Автор: Dagger · MIT**
...
Установите WireMod 3.0.0 и распакуйте архив дополнения в тот же каталог `content`.
...
Проверено совместно с WireMod 3.0.0 в локальной сборке VoxelCore проекта
...
Версия Advanced Logic из этого репозитория рассчитана на API WireMod 3.0.0.
