...
local device_id=api.register_device({'advanced_logic:bus_slice'},{inputs={input={dir=0,accept_bits={1,4,8,16}}},outputs={low={dir=2,bits=4,bits_field="part_bits"},high={dir=1,bits=4,bits_field="part_bits"}}})
