...
local device_id=api.register({'advanced_logic_2:bus_merger_4bit'},{inputs={bit0={dir=2,offset=0,bits=1},bit1={dir=2,offset=1,bits=1},bit2={dir=1,offset=0,bits=1},bit3={dir=3,offset=0,bits=1}},outputs={bus={dir=0,offset=0,bits=4}}})
