...
local device_id=api.register_device({'advanced_logic:bus_splitter_4bit'},{inputs={bus={dir=0,offset=0,accept_bits={1,4,8,16}}},outputs={bit0={dir=2,offset=0,bits=1},bit1={dir=2,offset=1,bits=1},bit2={dir=1,offset=0,bits=1},bit3={dir=3,offset=0,bits=1}}})
