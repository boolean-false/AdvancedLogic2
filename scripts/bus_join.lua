...
local device_id=api.register({'advanced_logic_2:bus_join'},{inputs={low={dir=0,bits=4,bits_field="part_bits"},high={dir=1,bits=4,bits_field="part_bits"}},outputs={output={dir=2,bits=8,bits_field="data_bits"}}})
...
function on_interact(x,y,z,playerid)
 return require('advanced_logic_2:component_settings').open(x,y,z,playerid,'parts')
end
