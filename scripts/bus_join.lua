...
local device_id=api.register_device({'advanced_logic:bus_join'},{inputs={low={dir=0,bits=4,bits_field="part_bits"},high={dir=1,bits=4,bits_field="part_bits"}},outputs={output={dir=2,bits=8,bits_field="data_bits"}}})
